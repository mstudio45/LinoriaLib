...
LeftGroupBox:AddToggle("MyToggle", {
	...
	Callback = function(Value) print("[cb] MyToggle changed to:", Value) end,
})
	:AddColorPicker("ColorPicker1", {
		...
		Callback = function(Value) print("[cb] Color changed!", Value) end,
	})
...
LeftGroupBox:AddSlider("MySlider", {
	...
	Callback = function(Value) print("[cb] MySlider was changed! New value:", Value) end,
})
...
LeftGroupBox:AddInput("MyTextbox", {
	...
	Callback = function(Value) print("[cb] Text updated. New text:", Value) end,
})
...
LeftGroupBox:AddDropdown("MyDropdown", {
	...
	Callback = function(Value) print("[cb] Dropdown got changed. New value:", Value) end,
})
...
LeftGroupBox:AddDropdown("MyMultiDropdown", {
	...
	Callback = function(Value) print("[cb] Multi dropdown got changed:", Value) end,
})
...
LeftGroupBox:AddDropdown("MyPlayerDropdown", {
	...
	Callback = function(Value) print("[cb] Player dropdown got changed:", Value) end,
})
LeftGroupBox:AddDropdown("MyTeamDropdown", {
	...
	Callback = function(Value) print("[cb] Team dropdown got changed:", Value) end,
})
...
LeftGroupBox:AddLabel("Keybind"):AddKeyPicker("KeyPicker", {
	...
	Callback = function(Value) print("[cb] Keybind clicked!", Value) end,

	-- Occurs when the keybind itself is changed, `New` is a KeyCode Enum OR a UserInputType Enum
	ChangedCallback = function(New) print("[cb] Keybind changed!", New) end,
})
...
Options.KeyPicker:OnChanged(function() print("Keybind changed!", Options.KeyPicker.Value) end)
...
task.spawn(function()
	while true do
		...
		if state then print("KeyPicker is being held down") end
