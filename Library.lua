...
function Library:Notify(Text, Time, SoundId)
    local SideOffset = Library.NotifyFromRightSide and 1 or 0
    ...
    local NotifyOuter = Library:Create('Frame', {
        BorderColor3 = Color3.new(0, 0, 0);
        Position = Library.NotifyFromRightSide and UDim2.fromOffset(-100, 10) or UDim2.fromOffset(100, 10);
    ...
    local NotifyLabel = Library:CreateLabel({
        Position = Library.NotifyFromRightSide and UDim2.fromOffset(-4, 0) or UDim2.fromOffset(4, 0);
        Size = UDim2.new(1, -4, 1, 0);
        Text = Text;
        TextXAlignment = Library.NotifyFromRightSide and Enum.TextXAlignment.Right or Enum.TextXAlignment.Left;
        TextSize = 14;
        ZIndex = 103;
        Parent = InnerFrame;
    });
    ...
    local SideColor = Library:Create('Frame', {
        ...
        BackgroundColor3 = Library.AccentColor;
        BorderSizePixel = 0;
        Position = UDim2.new(SideOffset, -1, 0, -1);
...
function Library:CreateWindow(...)
    ...
    if type(Config.NotifyFromRightSide) ~= 'boolean' then Library.NotifyFromRightSide = false else Library.NotifyFromRightSide = Config.NotifyFromRightSide end
    ...
    if Config.NotifyFromRightSide then
        Library.NotificationArea.AnchorPoint = Vector2.new(1, 0)
        Library.NotificationArea.Position = UDim2.new(1, 0, 0, 40)
    end
